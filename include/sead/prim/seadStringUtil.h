...
EFUN(0x007244E0, s32, sw16printf, EFUN_ARGS(char16* s, size_t n, const char16* format, ...));
s32 vsnprintf(char* s, size_t n, const char* format, va_list args);
EFUN(0x00723B70, s32, vsw16printf, EFUN_ARGS(char16* s, size_t n, const char16* format, std::va_list args));
// TODO
...
EFUN(0x00724ED0, s32, convertUtf8ToUtf16, EFUN_ARGS(char16* dst, u32 dst_len, const char* src, s32 src_len));
